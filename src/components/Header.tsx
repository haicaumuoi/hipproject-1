...
function Header() {
  ...
  const getAllAppilication = async () => {
      const respone = await axios
        .post("https://hipproback.herokuapp.com/api/appl/getallappl", {
          userID: user._id,
        });
    ...
    <div className="flex w-full h-[4.7rem] items-center justify-between border-b border-gray-200">
      ...
      <div className="flex items-center mx-2 xl:mx-10 h-full">
        <div className=" flex w-10 xl:w-32 justify-around items-end border-r border-r-gray-300 pr-5">
          ...
          <Link to={'/projects'}>
          <div className="cursor-pointer hover:bg-blue-400 transition-all rounded-full p-1" onClick={getAllAppilication}>
